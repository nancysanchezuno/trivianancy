...
while iniciar_trivia == True:
    ...
    print(
        GREEN +
        "            ***¡¡Bienvenidos a mi trivia!!***\n        ¿Conoces las capitales de los países de América?"
        + RESET)
    print()
    ...
    print(
        CYAN + "Hola", nombre,
        "esperamos que la pases genial,le recomendamos seguir las siguientes instrucciones para desarrollar la trivia:"
        + RESET)
    print()
    print(YELLOW + "1.Las respuestas deben estar en minúscula.")
    print(
        "2.El puntaje variará dependiendo si la respuesta es correcta o incorrecta."
    )
    print("3.Lee las preguntas cuantas veces consideres necesarias.")
    print(
        "4.Presiona la tecla Enter o Return luego de escribir tu respuesta." +
        RESET)
    print()
    print(
        WHITE +
        "Si está de acuerdo en continuar escriba 'si', o de lo contrario escriba 'no'."
        + RESET)
    print()
    ...
    while continuar not in ("si", "no"):
        continuar = input(
            YELLOW +
            "Debe responder si o no para poder continuar. Inténtalo nuevamente: "
            + RESET)
    if continuar == "si":
        time.sleep(1)
        print()
        ...
        for tiempo in range(5, 0, -1):
            ...
            time.sleep(1)
        print()
        print(RED + "Comenzarás con", puntaje,
              "puntos de bonificación. Aprovechalos!!!" + RESET)
        # PREGUNTA NUMERO 1 USANDO EL CICLO "FOR"
        print()
        print(
            MAGENTA +
            "1.¿Siguiendo el orden,¿cuales son las capitales de: Uruguay, Paraguay y Venezuela?"
            + RESET)
        print()
        ...
        respuesta_usuario = input(
            YELLOW + "Coloque la letra de la respuesta correcta:" + RESET)
        paises = ["Uruguay", "Paraguay", "Venezuela"]
        capitales = ["Montevideo", "Asunción", "Caracas"]
        respuesta_correcta = "a"
        while respuesta_usuario not in ("a", "b", "c", "d"):
            respuesta_usuario = input(
                "Debe responder a,b,c,d según considere correcto. Inténtalo nuevamente: "
            )
        ...
        if respuesta_usuario == "x":
            ...
            print(
                "Este es un mensaje secreto", nombre,
            ...
            print(
                "Correcto", nombre,
                "!! Ottawa es la capital de Canadá y la cuarta ciudad más grande del país."
            )
            print("Ottawa fue fundada en 1850.")
        elif respuesta_usuario == "b":
            puntaje -= random.randint(0, 4)
            print(
                "Lo lamentamos", nombre,
        ...
        print()
        print(RED + "Gracias", nombre, "por jugar mi trivia, alcanzaste",
        ...
        time.sleep(2)
        print(
            "Finalmente,puedes usar tu suerte para cambiar tu puntaje total.")
        print()
        print(
            RED +
            "Advertencia: Asi como tu puntaje puede duplicarse tambien podría dividirse."
            + RESET)
        print()
        suerte = input(GREEN + "Deseas probar tu suerte? Escribe si o no: " +
                       RESET)
        ...
        if suerte == "si":
            ...
            if numero_azar == 0:
                ...
                print()
                print(
                    "Usaste toda tu suerte, pero no fue suficiente y tu puntaje se dividió ",
                    nombre, ", tu puntaje total es:", puntaje)
            elif numero_azar == 1:
                puntaje = puntaje * 2
                time.sleep(1)
                print()
                print("Usaste toda tu suerte y lograste duplicarlo ", nombre,
                      ", tu puntaje total es: ", puntaje)
        else:
            print("Decidiste no usar tu suerte ", nombre,
                  ", tu puntaje total es: ", puntaje)
        ...
        if puntaje <= 50:
            ...
            print(
                MAGENTA +
                "No alcanzaste un puntaje alto pero no te desanimes, inténtalo de nuevo!"
            )
        if 50 <= puntaje <= 100:
            print()
        ...
        if 100 < puntaje:
            print()
            print(
                "Impresionante,alcanzaste un puntaje histórico. LO LOGRASTE!!!"
                + RESET)
        ...
        if repetir_trivia != "si":  # != significa "distinto"
            print(GREEN + "Espero", nombre,
                  "que te hayas divertido, hasta luego!!!" + RESET)
        ...
        print(
            GREEN + nombre,
            "lamentamos que no quieras continuar, puedes volver a intentar esta trivia en otro momento."
            + RESET)
        print()
        print(BLUE + "Hasta pronto", nombre, "!!"+RESET)
